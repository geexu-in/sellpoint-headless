...
class SliderRepository implements SliderRepositoryInterface
{
    ...
    public function getblockdata($identifier)
    {
       ...
       foreach ($someObject as $key => $value) {
        ...
        $cmsblockdata[] = ["active"=>$cmsBlock->getIsActive(),"blockid"=>$cmsBlock->getId(),"title"=>$cmsBlock->getTitle(),"identifier"=>$cmsBlock->getIdentifier(),"meta title"=> $cmsBlock->getMetaTitle(),"meta desc"=>$cmsBlock->getMetaDescription(),"content"=>$result];
        return $cmsblockdata;
    }
    /**
