...
namespace Geexu\BannerSlider\Model\Banners;

use Geexu\BannerSlider\Model\ResourceModel\Banners\CollectionFactory;
...
/**
 * Class DataProvider
 * @package Geexu\BannerSlider\Model\Banners
 */
class DataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{

    /**
     * @var \Geexu\BannerSlider\Model\ResourceModel\Banners\Collection
     */
    ...
    public function getData()
    {
        ...
        $data = $this->dataPersistor->get('geexu_bannerslider_banners');
        ...
        if (!empty($data)) {
            ...
            $this->dataPersistor->clear('geexu_bannerslider_banners');
        }
