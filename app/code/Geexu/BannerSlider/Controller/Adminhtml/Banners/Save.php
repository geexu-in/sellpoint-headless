...
use Geexu\BannerSlider\Model\Banners;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Geexu\BannerSlider\Model\ImageUpload
     */
    private $imageUpload;
    /**
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $this->imageUpload = \Magento\Framework\App\ObjectManager::getInstance()->get(\Geexu\BannerSlider\Model\ImageUpload::class);
            ...
            try {
                ...
                $this->dataPersistor->clear('geexubanner_bannerslider_banners');
