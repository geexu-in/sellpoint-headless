    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPost('tag')) {
            ...
            try {
                ...
                $this->_session->setData('geexu_blog_tag_data', false);

                if ($this->getRequest()->getParam('back')) {
                    $resultRedirect->setPath('geexu_blog/*/edit', ['id' => $tag->getId(), '_current' => true]);
                } else {
            ...
            $this->_getSession()->setData('geexu_blog_tag_data', $data);
