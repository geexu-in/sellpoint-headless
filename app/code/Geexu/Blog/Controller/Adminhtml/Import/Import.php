...
use Geexu\Blog\Model\Import\AheadWorksM1;
use Geexu\Blog\Model\Import\MageFanM2;
use Geexu\Blog\Model\Import\WordPress;
...
class Import extends Action
{
    ...
    {
        $data = $this->_getSession()->getData('geexu_blog_import_data');
        switch ($data['type']) {
            case 'wordpress':
