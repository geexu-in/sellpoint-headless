    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPost('post')) {
            ...
            try {
                ...
                $this->_getSession()->setData('geexu_blog_post_data', false);

                if ($this->getRequest()->getParam('back')) {
                    $resultRedirect->setPath('geexu_blog/*/edit', ['id' => $post->getId(), '_current' => true]);
                } else {
            ...
            $this->_getSession()->setData('geexu_blog_post_data', $data);
