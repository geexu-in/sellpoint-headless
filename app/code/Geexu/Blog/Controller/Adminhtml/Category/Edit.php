...
class Edit extends Category
{
    ...
    public function execute()
    {
         ...
         */
        $data = $this->_getSession()->getData('geexu_blog_category_data', true);
        ...
        if ($this->getRequest()->getQuery('isAjax')) {
            ...
            $content = $layout->getBlock('geexu.blog.category.edit')->getFormHtml()
                . $layout->getBlock('geexu.blog.category.tree')
            ...
            $this->_eventManager->dispatch(
                'geexu_blog_category_prepare_ajax_response',
        ...
        $resultPage->setActiveMenu('Geexu_Blog::category');
