...
class Category extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'geexu_blog_category';
     ...
     * @var string
     */
    protected $_cacheTag = 'geexu_blog_category';
     ...
     * @var string
     */
    protected $_eventPrefix = 'geexu_blog_category';
    ...
    public function getSelectedPostsCollection()
    {
        if (!$this->postCollection) {
            ...
            $collection->join(
                ['cat' => $this->getResource()->getTable('geexu_blog_post_category')],
