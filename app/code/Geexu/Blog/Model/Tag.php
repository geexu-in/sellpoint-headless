...
use Geexu\Blog\Model\ResourceModel\Tag\CollectionFactory as TagCollectionFactory;
...
class Tag extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'geexu_blog_tag';
     ...
     * @var string
     */
    protected $_cacheTag = 'geexu_blog_tag';
     ...
     * @var string
     */
    protected $_eventPrefix = 'geexu_blog_tag';
    ...
    public function getSelectedPostsCollection()
    {
        if ($this->postCollection === null) {
            ...
            $collection->join(
                ['post_tag' => $this->getResource()->getTable('geexu_blog_post_tag')],
