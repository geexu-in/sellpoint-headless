...
namespace Geexu\Blog\Model\ResourceModel\Comment\Grid;
...
/**
 * Class Collection
 * @package Geexu\Blog\Model\ResourceModel\Comment\Grid
 */
class Collection extends SearchResult
{
    ...
    public function __construct(
        ...
        $mainTable = 'geexu_blog_comment',
        $resourceModel = '\Geexu\Blog\Model\ResourceModel\Comment'
    ) {
    ...
    public function addPostName()
    {
        $this->getSelect()->joinLeft(
            ['mp' => $this->getTable('geexu_blog_post')],
