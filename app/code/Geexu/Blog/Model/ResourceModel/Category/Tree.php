...
namespace Geexu\Blog\Model\ResourceModel\Category;
...
use Geexu\Blog\Model\ResourceModel\Category;
use Zend_Db_Select;

/**
 * Class Tree
 * @package Geexu\Blog\Model\ResourceModel\Category
 */
class Tree extends Dbp
{
    ...
    public function __construct(
        ...
        parent::__construct(
            $coreResource->getConnection('geexu_blog_write'),
            $coreResource->getTableName('geexu_blog_category'),
            [
    ...
    public function initInactiveCategoryIds()
    {
        ...
        $this->eventManager->dispatch('geexu_blog_category_tree_init_inactive_category_ids', ['tree' => $this]);
    ...
    {
        $this->cache->clean([\Geexu\Blog\Model\Category::CACHE_TAG]);
