...
use Geexu\Blog\Api\Data\SearchResult\CategorySearchResultInterface;
...
class Collection extends AbstractCollection implements CategorySearchResultInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'geexu_blog_category_collection';
    ...
    {
        $this->_init(Category::class, \Geexu\Blog\Model\ResourceModel\Category::class);
    }
