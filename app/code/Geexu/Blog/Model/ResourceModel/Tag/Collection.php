...
namespace Geexu\Blog\Model\ResourceModel\Tag;

use Magento\Framework\DB\Select;
use Magento\Sales\Model\ResourceModel\Collection\AbstractCollection;
use Geexu\Blog\Api\Data\SearchResult\TagSearchResultInterface;
use Geexu\Blog\Model\Tag;
use Zend_Db_Select;

/**
 * Class Collection
 * @package Geexu\Blog\Model\ResourceModel\Tag
 */
class Collection extends AbstractCollection implements TagSearchResultInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'geexu_blog_tag_collection';
    ...
    {
        $this->_init(Tag::class, \Geexu\Blog\Model\ResourceModel\Tag::class);
    }
