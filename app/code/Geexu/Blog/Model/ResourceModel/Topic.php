...
class Topic extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->topicPostTable = $this->getTable('geexu_blog_post_topic');
    }
    ...
    {
        $this->_init('geexu_blog_topic', 'topic_id');
    }
    ...
    /**
     * @param \Geexu\Blog\Model\Topic $topic
     *
     * @return array
     */
    public function getPostsPosition(\Geexu\Blog\Model\Topic $topic)
    {
     ...
     * @return $this
     */
    protected function savePostRelation(\Geexu\Blog\Model\Topic $topic)
    {
