...
use Geexu\Blog\Model\Post as PostModel;
...
class Post extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->postTagTable      = $this->getTable('geexu_blog_post_tag');
        $this->postTopicTable    = $this->getTable('geexu_blog_post_topic');
        $this->postCategoryTable = $this->getTable('geexu_blog_post_category');
        $this->postProductTable  = $this->getTable('geexu_blog_post_product');
        $this->postTrafficTable  = $this->getTable('geexu_blog_post_traffic');
        $this->postAuthorTable   = $this->getTable('geexu_blog_author');
    }
    ...
    {
        $this->_init('geexu_blog_post', 'post_id');
    }
    ...
    public function saveCategoryRelation(PostModel $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'geexu_blog_post_change_categories',
    ...
    public function saveProductRelation(PostModel $post)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'geexu_blog_post_change_products',
