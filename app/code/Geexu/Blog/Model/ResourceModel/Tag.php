...
class Tag extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->tagPostTable = $this->getTable('geexu_blog_post_tag');
    }
    ...
    {
        $this->_init('geexu_blog_tag', 'tag_id');
    }
    ...
    /**
     * @param \Geexu\Blog\Model\Tag $tag
     *
     * @return array
     */
    public function getPostsPosition(\Geexu\Blog\Model\Tag $tag)
    {
     ...
     * @return $this
     */
    protected function savePostRelation(\Geexu\Blog\Model\Tag $tag)
    {
