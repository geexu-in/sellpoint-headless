...
class Category extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->categoryPostTable = $this->getTable('geexu_blog_post_category');
    }
    ...
    {
        $this->_init('geexu_blog_category', 'category_id');
    }
    ...
    protected function _beforeSave(AbstractModel $object)
    {
        ...
        /** @var \Geexu\Blog\Model\Category $object */
    ...
    protected function getMaxPosition($path)
    {
        ...
        $select = $adapter->select()->from(
            $this->getTable('geexu_blog_category'),
            'MAX(' . $positionField . ')'
        )->where(
    ...
    /**
     * @param \Geexu\Blog\Model\Category $category
     * @param \Geexu\Blog\Model\Category $newParent
    ...
    public function changeParent(
        \Geexu\Blog\Model\Category $category,
        \Geexu\Blog\Model\Category $newParent,
     ...
     * @return array
     */
    public function getPostsPosition(\Geexu\Blog\Model\Category $category)
    {
        $select = $this->getConnection()->select()->from(
     ...
     * @return $this
     */
    public function savePostRelation(\Geexu\Blog\Model\Category $category)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'geexu_blog_category_change_posts',
