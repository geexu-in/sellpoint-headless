...
use Geexu\Blog\Model\ResourceModel\Post as PostResource;
use Geexu\Blog\Model\ResourceModel\Post\Collection;
use Geexu\Blog\Model\ResourceModel\Post\CollectionFactory as PostCollectionFactory;
use Geexu\Blog\Model\ResourceModel\Tag\CollectionFactory;
...
class Post extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'geexu_blog_post';
     ...
     * @var string
     */
    protected $_cacheTag = 'geexu_blog_post';
     ...
     * @var string
     */
    protected $_eventPrefix = 'geexu_blog_post';
    ...
    public function getSelectedTagsCollection()
    {
        if ($this->tagCollection === null) {
            ...
            $collection->getSelect()->join(
                $this->getResource()->getTable('geexu_blog_post_tag'),
                'main_table.tag_id=' . $this->getResource()->getTable('geexu_blog_post_tag') . '.tag_id AND '
                . $this->getResource()->getTable('geexu_blog_post_tag') . '.post_id=' . $this->getId(),
                ['position']
    ...
    public function getSelectedTopicsCollection()
    {
        if ($this->topicCollection === null) {
            ...
            $collection->join(
                $this->getResource()->getTable('geexu_blog_post_topic'),
                'main_table.topic_id=' . $this->getResource()->getTable('geexu_blog_post_topic') . '.topic_id AND '
                . $this->getResource()->getTable('geexu_blog_post_topic') . '.post_id=' . $this->getId(),
                ['position']
            );
    ...
    public function getSelectedCategoriesCollection()
    {
        if ($this->categoryCollection === null) {
            ...
            $collection->join(
                $this->getResource()->getTable('geexu_blog_post_category'),
                'main_table.category_id=' . $this->getResource()->getTable('geexu_blog_post_category') .
                '.category_id AND ' . $this->getResource()->getTable('geexu_blog_post_category') . '.post_id="'
                . $this->getId() . '"',
                ['position']
            );
    ...
    public function getSelectedProductsCollection()
    {
        if ($this->productCollection === null) {
            ...
            $collection->getSelect()->join(
                $this->getResource()->getTable('geexu_blog_post_product'),
                'e.entity_id=' . $this->getResource()->getTable('geexu_blog_post_product')
                . '.entity_id AND ' . $this->getResource()->getTable('geexu_blog_post_product') . '.post_id='
                . $this->getId(),
                ['position']
            );
