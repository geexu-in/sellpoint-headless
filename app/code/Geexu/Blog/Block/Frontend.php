...
use Geexu\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Category as CategoryOptions;
use Geexu\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Tag as TagOptions;
use Geexu\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Topic as TopicOptions;
use Geexu\Blog\Helper\Data as HelperData;
use Geexu\Blog\Helper\Image;
use Geexu\Blog\Model\CategoryFactory;
use Geexu\Blog\Model\CommentFactory;
use Geexu\Blog\Model\Config\Source\AuthorStatus;
use Geexu\Blog\Model\LikeFactory;
...
class Frontend extends Template
{
    ...
    {
        return $this->getViewFileUrl('Geexu_Blog::media/images/geexu-logo-default.png');
    }
    ...
    {
        return $this->getViewFileUrl('Geexu_Blog::media/images/no-artist-image.jpg');
    }
}
