...
use Geexu\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Category;
use Geexu\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Tag;
use Geexu\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Topic;
use Geexu\Blog\Helper\Image;
use Geexu\Blog\Model\Config\Source\Author;
...
class Post extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $post = $this->_coreRegistry->registry('geexu_blog_post');
        ...
        $fieldset->addField('image', \Geexu\Blog\Block\Adminhtml\Renderer\Image::class, [
            'name' => 'image',
            'label' => __('Image'),
            'title' => __('Image'),
