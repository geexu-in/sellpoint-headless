...
use Geexu\Blog\Model\ResourceModel\Topic\CollectionFactory as BlogTopicCollectionFactory;
...
class Topic extends Multiselect
{
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Geexu_Blog::topic');
    ...
    public function getAfterElementHtml()
    {
        $html = '<script type="text/x-magento-init">
            ...
            $this->_urlBuilder->getUrl(
                ...
                [
                    'handle' => 'geexu_blog_topic_create',
                    'buttons' => 1
                ]
            ) . '",
                                        "autoRender": false,
