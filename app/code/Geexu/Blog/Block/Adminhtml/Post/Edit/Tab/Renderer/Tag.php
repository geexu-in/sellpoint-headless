...
use Geexu\Blog\Model\ResourceModel\Tag\Collection;
use Geexu\Blog\Model\ResourceModel\Tag\CollectionFactory as BlogTagCollectionFactory;
...
class Tag extends Multiselect
{
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Geexu_Blog::tag');
