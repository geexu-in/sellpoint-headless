...
namespace Geexu\Blog\Block\Adminhtml\Post\Edit\Tab;
...
use Geexu\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Action;
use Geexu\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Author;
use Geexu\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Categories;
use Geexu\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Store;
use Geexu\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Tags;
use Geexu\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Topics;
use Geexu\Blog\Model\ResourceModel\PostHistory\Collection;
use Geexu\Blog\Model\Tag;

/**
 * Class Product
 * @package Geexu\Blog\Block\Adminhtml\Post\Edit\Tab
 */
class History extends Extended implements TabInterface
{
    ...
    /**
     * @return \Geexu\Blog\Model\Post
     */
    public function getPost()
    {
        return $this->coreRegistry->registry('geexu_blog_post');
    }
    ...
    {
        return $this->getUrl('geexu_blog/post/history', ['_current' => true]);
    }
