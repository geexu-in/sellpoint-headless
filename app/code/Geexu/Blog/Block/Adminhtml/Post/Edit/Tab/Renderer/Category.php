...
namespace Geexu\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer;
...
use Geexu\Blog\Model\ResourceModel\Category\Collection;
use Geexu\Blog\Model\ResourceModel\Category\CollectionFactory as BlogCategoryCollectionFactory;
...
class Category extends Multiselect
{
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Geexu_Blog::category');
    ...
    public function getAfterElementHtml()
    {
        $html = '<script type="text/x-magento-init">
                            ...
                            "blogCategory": {
                                ...
                                "children": {
                                    "blog_select_category": {
                                        "component": "Geexu_Blog/js/components/new-category",
                                        "config": {
                                            "filterOptions": true,
                                            "disableLabel": true,
                                            "chipsEnabled": true,
            ...
            $this->_urlBuilder->getUrl(
                ...
                ['handle' => 'geexu_blog_category_create', 'buttons' => 1]
            ) . '",
                                        "autoRender": false,
