...
namespace Geexu\Blog\Block\Adminhtml\Comment\Edit\Tab;
...
/**
 * Class Comment
 * @package Geexu\Blog\Block\Adminhtml\Comment\Edit\Tab
 */
class Comment extends Generic implements TabInterface
{
    ...
    {
        $comment = $this->_coreRegistry->registry('geexu_blog_comment');
        ...
        $postText = '<a href="' . $this->getUrl('geexu_blog/post/edit', ['id' => $comment->getPostId()])
