...
use Geexu\Blog\Block\Adminhtml\Renderer\Image;
use Geexu\Blog\Helper\Data;
use Geexu\Blog\Helper\Image as ImageHelper;
use Geexu\Blog\Model\Config\Source\AuthorStatus;

/**
 * Class Author
 * @package Geexu\Blog\Block\Adminhtml\Author\Edit\Tab
 */
class Author extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $author = $this->_coreRegistry->registry('geexu_blog_author');
    ...
    {
        return $this->getUrl('geexu_blog/author/customergrid');
    }
}
