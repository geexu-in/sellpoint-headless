...
namespace Geexu\Blog\Block\Adminhtml\Category\Edit\Tab;
...
/**
 * Class Post
 * @package Geexu\Blog\Block\Adminhtml\Category\Edit\Tab
 */
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('geexu_blog_post_category')],
    ...
    /**
     * @return \Geexu\Blog\Model\Category
     */
    ...
    {
        return $this->getUrl('geexu_blog/category/posts', ['_current' => true]);
    }
