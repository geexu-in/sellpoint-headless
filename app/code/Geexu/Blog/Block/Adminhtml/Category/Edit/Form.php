...
namespace Geexu\Blog\Block\Adminhtml\Category\Edit;
...
use Geexu\Blog\Model\CategoryFactory as BlogCategoryFactory;
use Geexu\Blog\Model\ResourceModel\Category\Tree as BlogResourceTree;

/**
 * Class Form
 * @package Geexu\Blog\Block\Adminhtml\Category\Edit
 */
class Form extends AbstractCategory
{
    ...
    protected function _prepareLayout()
    {
        ...
        // Reset button
        $resetPath = $categoryId ? 'geexu_blog/*/edit' : 'geexu_blog/*/add';
    ...
    {
        /** @var \Geexu\Blog\Model\Category $category */
        ...
        return $this->getUrl('geexu_blog/*/save', $params);
    }
    ...
    {
        return $this->getUrl('geexu_blog/category/edit', ['_query' => false, 'id' => null, 'parent' => null]);
    }
    ...
    public function getDeleteUrl(array $args = [])
    {
        ...
        return $this->getUrl('geexu_blog/*/delete', $params);
    }
    ...
    public function getRefreshPathUrl(array $args = [])
    {
        ...
        return $this->getUrl('geexu_blog/*/refreshPath', $params);
    }
