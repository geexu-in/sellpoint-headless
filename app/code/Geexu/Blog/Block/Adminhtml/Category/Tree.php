...
use Geexu\Blog\Model\ResourceModel\Category\Tree as BlogTreeResource;
...
class Tree extends \Magento\Catalog\Block\Adminhtml\Category\Tree
{
    ...
    {
        return $this->getUrl('geexu_blog/category/jsonTree');
    }
    ...
    {
        return $this->getUrl('geexu_blog/category/move');
    }
