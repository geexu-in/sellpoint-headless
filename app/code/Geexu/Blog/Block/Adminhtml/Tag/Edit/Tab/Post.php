...
namespace Geexu\Blog\Block\Adminhtml\Tag\Edit\Tab;
...
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('geexu_blog_post_tag')],
    ...
    /**
     * @return \Geexu\Blog\Model\Tag
     */
    public function getTag()
    {
        return $this->coreRegistry->registry('geexu_blog_tag');
    }
    ...
    {
        return $this->getUrl('geexu_blog/tag/posts', ['_current' => true]);
    }
