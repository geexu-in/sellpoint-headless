...
namespace Geexu\Blog\Block\Adminhtml\Topic\Edit\Tab;
...
/**
 * Class Post
 * @package Geexu\Blog\Block\Adminhtml\Topic\Edit\Tab
 */
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('geexu_blog_post_topic')],
    ...
    /**
     * @return \Geexu\Blog\Model\Topic
     */
    public function getTopic()
    {
        return $this->coreRegistry->registry('geexu_blog_topic');
    }
    ...
    {
        return $this->getUrl('geexu_blog/topic/posts', ['_current' => true]);
    }
