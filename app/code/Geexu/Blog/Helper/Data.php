...
use Geexu\Blog\Model\ResourceModel\Category\Collection as CategoryCollection;
use Geexu\Blog\Model\ResourceModel\Post\Collection as PostCollection;
use Geexu\Blog\Model\ResourceModel\Tag\Collection as TagCollection;
use Geexu\Blog\Model\ResourceModel\Topic\Collection;
    ...
    public function getPostCollection($type = null, $id = null, $storeId = null)
    {
        ...
        switch ($type) {
            ...
            case self::TYPE_CATEGORY:
                $collection->join(
                    ['category' => $collection->getTable('geexu_blog_post_category')],
            ...
            case self::TYPE_TAG:
                $collection->join(
                    ['tag' => $collection->getTable('geexu_blog_post_tag')],
            ...
            case self::TYPE_TOPIC:
                $collection->join(
                    ['topic' => $collection->getTable('geexu_blog_post_topic')],
