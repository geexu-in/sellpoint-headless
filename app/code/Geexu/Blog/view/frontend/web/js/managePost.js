...
define([
    ...
    'uiRegistry',
    'moment',
    "Geexu_Blog/js/get-editor"
], function ($, $t, _, modal, registry, moment, editor) {
    'use strict';

    $.widget('geexu.mpBlogManagePost', {
            options: {
                deleteUrl: '',
                basePubUrl: '',
                postDatas: {},
            ...
            _setPopupFormData: function(postData, pubUrl, htmlPopup){
                _.each(postData, function (value, name) {
                    ...
                    if (field.is('[type="file"]') && value) {
                        imageEL = '<a class="mp-image-link" href="' + pubUrl + 'geexu/blog/post/' + value
                            + '" onclick="imagePreview(\'post_image_image\'); return false;" >' +
                            '<img src="' + pubUrl + 'geexu/blog/post/' + value + '" id="post_image_image"' +
