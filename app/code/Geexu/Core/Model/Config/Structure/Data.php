...
namespace Geexu\Core\Model\Config\Structure;

use Magento\Config\Model\Config\Structure\Data as StructureData;
use Geexu\Core\Block\Adminhtml\System\Config\Button;
use Geexu\Core\Block\Adminhtml\System\Config\Docs;
use Geexu\Core\Block\Adminhtml\System\Config\Form\Field\Version;
use Geexu\Core\Block\Adminhtml\System\Config\Message;
use Geexu\Core\Helper\Validate as Helper;

/**
 * Plugin to add 'Module Information' group to each modules (before general group)
 *
 * Class Data
 * @package Geexu\Core\Model\Config\Structure
 */
class Data
{
    /**
    ...
    public function beforeMerge(StructureData $object, array $config)
    {
        ...
        foreach ($sections as $sectionId => $section) {
            if (isset($section['tab']) && ($section['tab'] === 'geexu') && ($section['id'] !== 'geexu')) {
    ...
    protected function getFieldList()
    {
        return [
            ...
            'name'        => [
                ...
                'frontend_class' => 'geexu-module-active-field-free geexu-module-active-name',
                'show'           => Helper::MODULE_TYPE_FREE
            ],
            'email'       => [
                'label'          => __('Register Email'),
                'validate'       => 'required-entry validate-email',
                'frontend_class' => 'geexu-module-active-field-free geexu-module-active-email',
                'comment'        => __('This email will be used to create a new account at Geexu.com, Geexu help desk (to get priority support).'),
                'show'           => Helper::MODULE_TYPE_FREE
            ],
            'product_key' => [
                'label'          => __('Product Key'),
                'frontend_class' => 'geexu-module-active-field-key',
                'show'           => Helper::MODULE_TYPE_FREE
            ],
            'button'      => [
