...
namespace Geexu\Core\Model\Message;

use Magento\Framework\Notification\MessageInterface;
use Magento\Framework\Phrase;
use Magento\Framework\UrlInterface;
use Geexu\Core\Helper\Validate as ValidateHelper;

/**
 * Class Validate
 * @package Geexu\Core\Model\Message
 */
class Validate implements MessageInterface
{
    ...
    {
        return hash('md5', 'GEEXU_VALIDATE_MESSAGE');
    }
    ...
    public function getText()
    {
        ...
        return __(
            'One or more Geexu extensions are not validated. Click <a href="%1">here</a> to validate them.',
            $url
        );
    }
