        ...
        if ($this->_geexuModules === null) {
            ...
            if ($allowList) {
                ...
                foreach ($moduleList as $name) {
                    if (strpos($name, 'Geexu_') === false) {
                        continue;
                    }

                    $this->_geexuModules[] = $name;
                }
            }
        }

        return $this->_geexuModules;
    }
}
