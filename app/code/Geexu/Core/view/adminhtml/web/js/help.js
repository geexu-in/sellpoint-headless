...
require([
        ...
        'admin/system_config/index': [
            {
                ...
                'url': 'https://www.geexu.com/kb/how-enable-single-store-mode-magento-2.html',
                'anchor': 'learn more'
            }
        ],
        'theme/design_config/edit/scope/websites/scope_id': [
            {
                ...
                'url': 'https://www.geexu.com/kb/how-change-welcome-message-magento-2.html',
                'anchor': 'learn more'
            }
        ],
        'system_config/edit/section/contact': [
            {
                ...
                'url': 'https://www.geexu.com/kb/how-configure-contacts-email-address-magento-2.html',
                'anchor': 'learn more'
            }
        ],
        //Not Configuration
        'catalog/product/edit': [
            {
                ...
                'url': 'https://www.geexu.com/kb/how-to-upload-images-product-in-magento-2.html',
                'anchor': 'learn more'
            }
        ],
        'type/configurable/key/': [
            {
                ...
                'url': 'https://www.geexu.com/kb/how-create-configurable-product-magento-2.html',
                'anchor': 'learn more'
            }
        ],
        'system_config/edit/section/general': [
            {
                ...
                'url': 'https://www.geexu.com/kb/how-setup-locale-state-country-magento-2.html#set-up-state',
                'anchor': 'learn more'
            },
            {
                ...
                'url': 'https://www.geexu.com/kb/how-setup-locale-state-country-magento-2.html#set-up-country',
                'anchor': 'learn more'
            },
            {
                ...
                'url': 'https://www.geexu.com/kb/how-setup-locale-state-country-magento-2.html#login-magento-2',
                'anchor': 'learn more'
            },
            {
                ...
                'url': 'https://www.geexu.com/kb/how-setup-store-information-magento-2.html',
                'anchor': 'learn more'
            }
        ...
        'system_config/edit/section/trans_email': [
            {
                ...
                'url': 'https://pages.geexu.com/abandoned-cart-email-templates-for-magento/',
                'anchor': 'learn more'
            },
        ],
        'system_config/edit/section/newsletter': [
            {
                ...
                'url': 'https://pages.geexu.com/welcome-email-templates-for-magento-2/',
                'anchor': 'get a copy'
            }
        ...
        'admin/email_template/new': [
            {
                ...
                'url': 'https://pages.geexu.com/bundle-of-email-follow-up-templates/',
    ...
    function buildHtml(data) {
        var link = '<a href="' + data.url + '?utm_source=store&utm_medium=link&utm_campaign=geexu-helps" target="_blank">' + data.anchor + '</a>';
