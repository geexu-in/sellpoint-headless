        ...
        //var_dump();
            ...
            if($collection->getSku()){
               ...
               $save = $_savingPercent;
                ...
                $ProductDetails[] =["id" => $Id,"name"=> $Name,"specialprice" =>$SpecialPrice,"regularprice"=>$RegularPrice,"image"=>$Image,"producturl"=>$Product_url,"short description"=>$short_description,"stockstatus"=>$stock_status,"sku"=>$sku,"save"=>$save];
            }
            //code ends here
